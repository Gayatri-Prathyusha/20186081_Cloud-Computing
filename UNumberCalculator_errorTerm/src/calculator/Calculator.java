 ...
 * @version 4.02    The mainline of a JavaFX-based GUI implementation of a double calculator
 * @version 4.03    The mainline of a JavaFX-based GUI implementation of a double calculator with error terms.
 */
...
public class Calculator extends Application {
	...
	public void start(Stage theStage) throws Exception {
		...
		theStage.setTitle("Anuhya");				// Label the stage (a window)
