...
//	public static int measuredValueIndexofError = -1;	// The index where the error was located
	public static String errorTermErrorMessage = "Error Term recognition has not been implemented";
	...
	public static int currentCharNdx;					// The index of the current character
	...
	private static String displayInput(String input, int currentCharNdx) {
		...
		String result = input.substring(0,errorTermIndexofError) + "";
	...
	public static String checkErrorTerm(String input) {
		...
		case 1:
			...
			if (currentCharNdx<input.length()) {
				...
				errorTermErrorMessage = "This character may only be an \"E\", an \"e\", a digit, "
						+ "a \".\", \nor it must be the end of the input.\n";
				return displayInput(input, currentCharNdx)+errorTermErrorMessage;
			}
			else {
		...
		case 9:
			// State 9 is not a final state.  In order to move forward, the next character must be
			// a digit or a plus or a minus character.
			errorTermErrorMessage = "This character may only be a digit, a plus, or minus "
					+ "character.\n";
			return displayInput(input, currentCharNdx)+errorTermErrorMessage;
