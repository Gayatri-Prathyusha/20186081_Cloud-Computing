 ...
 * * @version 4.01	2019-02-19	updates with extra test cases.
 * 
 */
...
public class TestBusinessLogic {
	...
	public static void main(String[] args) {
		...
		if (check("\n******************\n" + 
				...
				"*\n" + 
				"******************\n" + 
				"operand1 = 0.00000000000000000000,0.00000000000000000000,-1\n" + 
				"     operand1ErrorMessage = \n" + 
				"     operand1Defined = false\n" + 
				"operand2 = 0.00000000000000000000,0.00000000000000000000,-1\n" + 
				"     operand2ErrorMessage = \n" + 
				"     operand2Defined = false\n" + 
				"result = 0.00000000000000000000,0.00000000000000000000,-1\n" +
				"     resultErrorMessage = \n" + 
				"*******************\n\n", test.debugToString())) {
			numPassed++;
		...
		if (check("\nReturned boolean = true\n******************\n" + 
				...
				"*\n" + 
				"******************\n" + 
				"operand1 = 1234567890123400.,0.00000000000000000000,-1\n" + 
				"     operand1ErrorMessage = \n" + 
		...
		if (check("\nReturned boolean = true\n******************\n" + 
				...
				"     operand1ErrorMessage = \n" + 
				"     operand1Defined = false\n" + 
				"operand2 =  1234560123456700.,0.00000000000000000000,-1\n" + 
				"     operand2ErrorMessage = \n" + 
				"     operand2Defined = true\n" + 
				"result =  1234560123456700.,0.00000000000000000000,-1\n" +
				"     resultErrorMessage = \n" + 
				"*******************\n\n", "\nReturned boolean = " + flag + test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string = 9.9999999E7,0.0,-1\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
				"operand1 = 12345678.000000,0.00000000000000000000,-1\n" + 
				"     operand1ErrorMessage = \n" + 
				"     operand1Defined = true\n" + 
				"operand2 = 87654321.000000,0.00000000000000000000,-1\n" + 
				"     operand2ErrorMessage = \n" + 
				"     operand2Defined = true\n" + 
				"result = 99999999.000000,0.00000000000000000000,-1\n" +
				"     resultErrorMessage = Incompatible Units for addition\n" + 
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string = -7.5308643E7,0.0,-1\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
				...
				"     operand2ErrorMessage = \n" + 
				"     operand2Defined = true\n" + 
				"result = -75308643.000000,0.00000000000000000000,-1\n" +
				"     resultErrorMessage = Incompatible Units for Subtraction \n" + 
				"*******************\n\n", "\nReturned string = " + answer + test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string =1.0821520223746E15,0.0,-1\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
				...
				"     operand2ErrorMessage = \n" + 
				"     operand2Defined = true\n" + 
				"result =1082152022374600.,0.00000000000000000000,-1\n" +
				"     resultErrorMessage =  Incompatible Units for Multiplication\n" + 
				"*******************\n\n", "\nReturned string = " + answer + test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		...
		if (check("\nReturned string =\n******************\n" + 
				...
				"     operand2ErrorMessage = \n" + 
				"     operand2Defined = true\n" + 
				"result =0.14084505885340,0.0000000000000000000000000000,-1\n" +
				"     resultErrorMessage = Incompatible Units for Division\n" + 
				"*******************\n\n", "\nReturned string = " + answer + test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		...
		//15. Perform division test
		test = new BusinessLogic();											// Set up for the test
		
		test.setOperand1("0.1");
		test.setOperand2("0.2");
		answer = test.division();
		...
		if (check("\nReturned string =\n******************\n" + 
				...
				"*\n" + 
				"******************\n" + 
				"operand1 = 0.10000000000000,0.00000000000000000000,-1\n" + 
				"     operand1ErrorMessage = \n" + 
				"     operand1Defined = true\n" + 
				"operand2 = 0.20000000000000,0.00000000000000000000,-1\n" + 
				"     operand2ErrorMessage = \n" + 
				"     operand2Defined = true\n" + 
				"result =  0.50000000000000,0.00000000000000000000,-1\n" +
				"     resultErrorMessage = Incompatible Units for Division\n" + 
				"*******************\n\n", "\nReturned string = " + answer + test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		...
		if (check("\nReturned string = \n******************\n" + 
				...
				"     operand2ErrorMessage = \n" + 
				"     operand2Defined = false\n" + 
				"result = 0.3162277660172657,0.00000000000000000000,-1\n" +
				"     resultErrorMessage = Incompatible Unit for Sqrt\n" + 
				"*******************\n\n", "\nReturned string = " + answer + test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
